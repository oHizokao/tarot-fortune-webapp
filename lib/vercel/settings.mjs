...
export const TAROT_RESPONSE_FORMAT = [
  ...
  "สำหรับไพ่แต่ละใบ ให้ใช้หัวข้อ: ไพ่ใบที่ N — [ชื่อคำบนไพ่] แล้วตามด้วยบรรทัด ความหมายของไพ่: ... และ เชื่อมโยงกับคำถาม: ...",
  "หลังอธิบายไพ่ครบทุกใบ ให้ใช้หัวข้อ สรุปคำตอบ: ... เพื่อสรุปและตอบคำถามของผู้ใช้โดยตรง",
  "ปิดท้ายด้วยหัวข้อ คำแนะนำถัดไป: ... และถ้าเหมาะสมให้มี คำถามชวนทบทวน: ... หนึ่งข้อ",
