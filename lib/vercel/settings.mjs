...
export const DEFAULT_TAROT_PROMPT = [
  ...
  "ถ้าคำถามเป็นเรื่องข้อเท็จจริงที่ไพ่ยืนยันไม่ได้ ให้บอกข้อจำกัดอย่างสั้น ๆ แล้วตอบในทิศทางของเจตนาคำถามด้วยคำแนะนำเชิงสัญลักษณ์ที่นำไปใช้ได้ ห้ามตัดบทหรือเปลี่ยนไปพูดเรื่องอื่น",
...
export const TAROT_RESPONSE_FORMAT = [
  ...
  "ห้ามใช้ Markdown หรือเครื่องหมายจัดรูปแบบ เช่น **, __, # และห้ามใช้รายการแบบขีดนำหน้า เพราะหน้าเว็บจะจัดรูปแบบให้อ่านเอง",
  "ถ้าเปิดไพ่หลายใบ ให้ตอบแยกทีละใบตามจำนวนไพ่จริง ห้ามรวบความหมายของหลายใบเป็นก้อนเดียว",
  "สำหรับไพ่แต่ละใบ ให้ใช้หัวข้อ: ไพ่ใบที่ N — [ชื่อคำบนไพ่] แล้วตามด้วยบรรทัด ความหมายของไพ่: ... และ คำทำนาย: ...",
  "หลังอธิบายไพ่ครบทุกใบ ให้ใช้หัวข้อ สรุปคำตอบ: ... เพื่อสรุปและตอบคำถามปัจจุบันโดยตรง ห้ามสรุปแบบกว้างจนไม่ระบุทิศทางคำตอบ",
