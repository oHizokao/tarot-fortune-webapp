...
import { currentSession, findBetaByAccessCode, findUserByLogin, isValidUsername, normalizeUsername, publicUser, refreshUserStatus } from "../auth.mjs";
...
export async function login(request) {
  ...
  if (user.status === "pending") throw new AppError("สมัครสมาชิกสำเร็จแล้ว กรุณารอผู้ดูแลอนุมัติก่อนเข้าสู่ระบบ", 403, "ACCOUNT_PENDING");
