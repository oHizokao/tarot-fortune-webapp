const COPY = {
  ...
  BETA_LOGIN_FAILED: "Beta Access Code ไม่ถูกต้องหรือหมดอายุแล้ว",
  ...
  AI_RATE_LIMITED: "โควตา/เครดิตของ OpenAI ยังไม่พร้อม กรุณาตรวจ Billing หรือ Usage แล้วลองใหม่",
  ...
  OPENAI_AUTH_FAILED: "API key ของ OpenAI ใช้งานไม่ได้หรือไม่มีสิทธิ์ กรุณาให้ผู้ดูแลตรวจสอบคีย์และ Project",
  ...
  SESSION_CREATE_FAILED: "สร้างสำรับไพ่ไม่สำเร็จ กรุณาลองเปิดไพ่ใหม่อีกครั้ง",
