...
import { betaLogin, changePassword, login, logout, me, register } from "../../lib/vercel/routes/auth.mjs";
...
async function dispatch(request) {
  ...
  if (request.method === "POST" && route === "change-password") return changePassword(request);
