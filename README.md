...
- `/login/` สมัครสมาชิกและเข้าสู่ระบบด้วย username + password
...
- `/admin/` เป็น Admin Landing Page และ Control Room สำหรับสมาชิก สิทธิ์ AI, API key และสถิติ
...
4. เพิ่ม Environment Variables ใน Vercel:
   ...
   - `OPENAI_MODEL` — รุ่น API ที่บัญชีเปิดใช้
...
7. ล็อกอินหลังบ้าน แล้วใส่ OpenAI API key/model ในส่วนตั้งค่า AI
...
5. สมาชิกล็อกอินอีกครั้งที่ `/login/` แล้วเข้า `/ai/` เพื่อเลือกไพ่ พิมพ์คำถาม และรับคำตอบ
